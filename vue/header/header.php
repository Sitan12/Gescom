...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" style="font-weight: bold; font-size: 22px;" id="pli">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" style="color: #32459d; " aria-current="page" href="accueil.php">Accueil</a>
            </li>
            <li class="nav-item">

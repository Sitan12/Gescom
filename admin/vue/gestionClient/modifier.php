      ...
      ?>
        ...
        <form class=" p-4" method="POST" action="edit.php" enctype="multipart/form-data">
            <div class="row font-weight-bolder" >
              <div class=" card bg-light offset-2 p-4 col-md-8">
              <h5 class="text-center p-1 card bg-success" style="color: white; font-style: italic;">Modifier les champs pour modifier les informations du client</h5>

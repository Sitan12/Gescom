  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form class=" p-4" method="POST" action="../../controlleur/traitementEmployer.php" enctype="multipart/form-data">
        <h5 class="text-center">Veuillez Remplir les champs</h5>
              <label >Nom</label>
            ...
            <div class="row ">
              <input type="radio" class="mt-1 mr-2" name="poste" value="DG">Directeur General
              <input type="radio" class="mt-1 ml-1 mr-2" name="poste" value="assistant">Assistant
              <input type="radio" cheked class="mt-1 ml-1 mr-2" name="poste" value="technicien">Technicien
              <input type="radio" class="mt-1 ml-1 mr-2" name="poste" value="gerant">Gerant
              <input type="radio" class="mt-1 ml-1 mr-2" name="poste" value="autres">Autres
            </div>
              <label >Salaire</label>
        ...
        <div class="card col-md-12 p-4"> 
          <div class="row p-4">
             ...
             <form method="POST" action="" class="input-group col-md-5"> 
                <input type="text" class="form-control " placeholder="Rechercher un employé" name="recherche">

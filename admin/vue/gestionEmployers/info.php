  ...
  <div class="row">
    ...
    <main class=" container p-4 all-content-wrapper" style="margin-left: 220px;">
        ...
        <div class="row p-4 container-fluid">
            <div class="p-4 card bg-light col-md-8 offset-md-2 mb-3"> 
                <h4 class="text-center p-1 card bg-info">Fiche d'Informations sur 
            ...
            while($row = $result->fetch_assoc()){?>
                ...
                <h4>Prenom: <label for=""><?=$row['prenom']?></label></h4>
                <h4>Telephone: <label for=""><?=$row['telephone']?></label></h4>
                ...
                <h4>Date D'intergration ACS: <label for=""><?=$row['DateIntegration']?></label></h4>
                <h4>Conges: <label for=""><?=$row['conges']?></label></h4>
                ...
                <div class="justify-content-center">
                       <a href="supprimer.php?tel=<?=$row['telephone']?>" class="btn btn-danger" ><i class="fas fa-trash-alt"></i></a>
                        <a href="modifier.php?tel=<?=$row['telephone']?>" class="btn btn-primary" >Modifier les informations</a>  
                </div>

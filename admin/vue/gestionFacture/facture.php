...
<!-- Formulaire commande -->
<div class="container-fluid">
    <h4 class="card bg-light col-md-4 offset-4 mt-4 text-center" style="font-family: 'Times New Roman'; font-weight: 150; font-style: italic; "> Formulaire de Facture:</h4>
  <form class="insert-form card bg-light p-4" method="POST" action="../../controlleur/traitementFacture.php" enctype="multipart/form-data">
    <div class="input-field p-4">
                ...
                <div class="row ">
                  ...
                  <div class="row">
                  <div class="col-md-7 input-group mb-3" style="font-family: 'Times New Roman'; font-weight: 150;">
      ...
      <?php while($row = $result->fetch_assoc()){?><option value="<?=$row['id']?>"><?=$row['nomProduit']?></option><?php } ?>
        ...
        <center>
        <button class="btn btn-success" style="color:cornsilk; font-weight:bold;" name="save">Générer la facture</button>
        </center>
    </div>  
  </form>     
</div>  

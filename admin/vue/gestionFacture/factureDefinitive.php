...
<div class="container-fluid">
  <div class="row">
    ...
    <div class="container">
      ...
      ?>
      <div class="row p-4">
          <div class="col-md-3 p-4 offset-1">
              <table class="table ">
        ...
        <table class="table table-bordered"  style="margin-bottom: 150px;" >
          ...
          <tbody>
           <?php
            ...
            <tr align="center">
                <td ><?=$row['quantite']?></td>
                <td ><?php $rst=$conn->query("SELECT nomProduit,descriptionProduit FROM produit INNER JOIN facturedefinitive ON produit.id = facturedefinitive.produit");
                              if($ligne=$rst->fetch_assoc()){
                                $nom=$ligne['nomProduit']; 
                                $desc=$ligne['descriptionProduit'];
                              } echo $nom.'<br>'.$desc; ?></td>
